...
class PatientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'lastname' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'mothersname' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'address' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            ...
            'by_patient_number' => ['type' => 'index', 'columns' => ['patientnumber'], 'length' => []],
            'by_name' => ['type' => 'index', 'columns' => ['name'], 'length' => []],
            'by_lastname' => ['type' => 'index', 'columns' => ['lastname'], 'length' => []],
            'by_fullname' => ['type' => 'index', 'columns' => ['lastname', 'name', 'mothersname'], 'length' => []],
        ],
        '_constraints' => [
